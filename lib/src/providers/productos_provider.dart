...
class ProductosProvider {
  final String _url = 'https://flutter-varios-dfd85.firebaseio.com';
  ...
  Future<String> subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/doqfqkcnn/image/upload?upload_preset=nl9n0g9l');

    final mimeType = mime(imagen.path)
        .split('/'); //visualiza la extension de la imagen que se va a cargar
